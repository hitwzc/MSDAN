...
class MSDAN(nn.Module):
    ...
    def __init__(self, num_classes=7):
        ...
        self.cls_fc_son1 = nn.Linear(5 * N, num_classes)
        self.cls_fc_son2 = nn.Linear(5 * N, num_classes)
    ...
    def forward(self, data_src, data_tgt = 0, label_src = 0, mark = 1):
        ...
        if self.training == True:
            ...
            data_tgt_son1 = data_tgt_son1.view(data_tgt_son1.size(0), -1)      # 到这里 转化为 完全连接层了！！
            ...
            if mark == 1:
                ...
                return cls_loss, lmmd_loss, l1_loss
            ...
            if mark == 1:
                return pred1, pred2, fea_son1
            if mark == 2:
                return pred1, pred2, fea_son2
